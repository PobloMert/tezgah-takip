@echo off
chcp 65001 >nul
title TezgahTakip v2.1.3 - Kurulum

echo.
echo ╔══════════════════════════════════════════════════════════════╗
echo ║                    TezgahTakip v2.1.3 KURULUM                 ║
...
copy "TezgahTakip_v2.1.3.exe" "%INSTALL_DIR%\" >nul
...
echo sLinkFile = "%DESKTOP%\TezgahTakip v2.1.3.lnk" >> "%TEMP%\shortcut.vbs"
echo Set oLink = oWS.CreateShortcut(sLinkFile) >> "%TEMP%\shortcut.vbs"
echo oLink.TargetPath = "%INSTALL_DIR%\TezgahTakip_v2.1.3.exe" >> "%TEMP%\shortcut.vbs"
echo oLink.WorkingDirectory = "%INSTALL_DIR%" >> "%TEMP%\shortcut.vbs"
echo oLink.Description = "TezgahTakip v2.1.3 - AI Güçlü Fabrika Bakım Sistemi" >> "%TEMP%\shortcut.vbs"
...
echo sLinkFile = "%STARTMENU%\TezgahTakip v2.1.3.lnk" >> "%TEMP%\startmenu.vbs"
echo Set oLink = oWS.CreateShortcut(sLinkFile) >> "%TEMP%\startmenu.vbs"
echo oLink.TargetPath = "%INSTALL_DIR%\TezgahTakip_v2.1.3.exe" >> "%TEMP%\startmenu.vbs"
echo oLink.WorkingDirectory = "%INSTALL_DIR%" >> "%TEMP%\startmenu.vbs"
echo oLink.Description = "TezgahTakip v2.1.3 - AI Güçlü Fabrika Bakım Sistemi" >> "%TEMP%\startmenu.vbs"
...
echo.
echo 🎉 TezgahTakip v2.1.3 kullanıma hazır!
